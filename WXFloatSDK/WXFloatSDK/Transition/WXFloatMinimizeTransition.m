...
@interface WXFloatMinimizeTransition()<CAAnimationDelegate>

@property (nonatomic, strong)id<UIViewControllerContextTransitioning> transitionContext;

@end

@implementation WXFloatMinimizeTransition
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext
{
    ...
    UIBezierPath *startPath = [UIBezierPath bezierPathWithRoundedRect:fromVc.view.frame cornerRadius:moveView.frame.size.width/2];
    UIBezierPath *endPath = [UIBezierPath bezierPathWithRoundedRect:moveView.frame cornerRadius:moveView.frame.size.width/2];
